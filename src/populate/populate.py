...
if __name__ == "__main__":
	...
	categoria(); file.write('\n')
	super_categoria(); file.write('\n')
	categoria_simples(); file.write('\n')
	produto(); file.write('\n')
	retalhista(); file.write('\n')
	ivm(); file.write('\n')
	prateleira(); file.write('\n')
	ponto_de_retalho(); file.write('\n')
	planograma(); file.write('\n')
	instalada_em(); file.write('\n')
	tem_categoria(); file.write('\n')
	tem_outra(); file.write('\n')
	evento_reposicao(); file.write('\n')
	responsavel_por()
